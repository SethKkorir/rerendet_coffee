...
const AuthModal = ({ isOpen, onClose, initialView = 'login' }) => {
    const { login, register, loginWithGoogle, loading: authLoading, showSuccess, showError } = useContext(AppContext);
                ...
                >
                    ...
                    <div className="auth-content">
                        ...
                        <div className="auth-header">
                            <div className="auth-logo"><FaCoffee /> Rerendet</div>
                            <h2>
                        ...
                        <AnimatePresence mode="wait">
                                    ...
                                    {signupStep === 4 && (
                                        <>
                                            ...
                                            <div className="form-group" style={{ flexDirection: 'row', alignItems: 'center', gap: '10px' }}>
                                                ...
                                                />
                                                <label style={{ fontSize: '0.8rem' }}>I agree to Terms & Conditions</label>
                                            </div>
                            ...
                            {(view === 'verify-email' || view === 'reset-password') && (
                                <motion.form
                                    ...
                                    initial="hidden" animate="visible" exit="exit"
                                    className="auth-form"
                                    onSubmit={view === 'reset-password' ? handleResetPassword : handleVerification}
                                >
                                    {view === 'verify-email' && (
                                    ...
                                    <button type="submit" className="primary-btn" disabled={loading}>
                                        {loading ? 'Verifying...' : (view === 'reset-password' ? 'Reset Password' : 'Verify Account')}
                                    </button>
